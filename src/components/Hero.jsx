  ...
  return (
    <main className="relative w-full h-screen overflow-hidden flex justify-center mb-[10%]">
      ...
      <div className="absolute bottom-[15%] flex flex-col items-center gap-5">
        ...
        <h1 className="md:text-2xl text-1x1 font-bold">
        ...
        <button
          className="h-10 px-16 bg-gradient-to-r from-purple-500 to-indigo-600 rounded-lg
        ...
        <p className="max-w-[80%] text-center tex-[#babaff]">
          Notice: Druid's Wrath are in Beta. Participation involes risk. Read
