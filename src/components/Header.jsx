...
const Header = () => {
  // Simple function to tohgle the mobile menu
    ...
    <header className="py-1 px-7 flex justify-between items-center sticky top-0 z-50 w-full border-b-[0.3px] border-[#babaff] bg-black">
      ...
      <div className="flex lg:gap-14 gap-4">
        ...
        <div className="hidden md:flex gap-5 items-center">
          <button
            className="h-8 px-6 bg-gradient-to-r from-purple-500 to-indigo-600 rounded-lg
          ...
          <button
            className="h-8 px-6 bg-gradient-to-r from-gray-600 to-gray-400 rounded-lg
            font-medium text-nowrap hover:opacity-70 transition-all duration-300"
          >
            PLAY NOW
          </button>
      ...
      <nav className="hidden md:flex lg:gap-8 gap-4">
        ...
        after:left-0 after:bottom-0 after:transition-all hover:after:w-full text-nowrap"
        >
          <i class="bx bx-diamond"></i> Beranda
        </a>
        ...
        after:left-0 after:bottom-0 after:transition-all hover:after:w-full text-nowrap"
        >
          <i class="bx bx-chevrons-up"></i> Gameplay
        </a>
      ...
      <div
        id="mobileMenu" className="hidden fixed top-14 right-0 left-0 bg-black p-5 md:hidden"
      >
